...
_CMSGCLIENTWALLETINFOUPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\240\266\030\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
CMsgClientAppMinutesPlayedData = _reflection.GeneratedProtocolMessageType('CMsgClientAppMinutesPlayedData', (_message.Message,), {
  ...
  'AppMinutesPlayedData' : _reflection.GeneratedProtocolMessageType('AppMinutesPlayedData', (_message.Message,), {
...
CMsgClientUnsignedInstallScript = _reflection.GeneratedProtocolMessageType('CMsgClientUnsignedInstallScript', (_message.Message,), {
