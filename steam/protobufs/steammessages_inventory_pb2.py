...
_CINVENTORY_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\202\265\0303If true, the requestid given was processed earlier.', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CINVENTORY_ADDITEM_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\202\265\030HShould notify the user that the item was added to their Steam Inventory.', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\202\265\030KIf true, apply the default trade and market restriction times to this item.', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\202\265\030fIf set, treat requestid as a txnid and create this item as a result of user microtransaction purchase.', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
